...
use eris_macro::ErisDisplayEmoji;
...
impl AmuletOfArcaneAscendance {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			armor: SerialDie {die:Die::D4, quantity:0 }.to_die(),
			resistance: HashMap::from([(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			damage: HashMap::from([(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
...
impl AsgardianAegis {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			resistance: HashMap::from([(DamageType::Despair, SerialDie { die: Die::D12, quantity: 2 }.to_die()),(DamageType::Boss, SerialDie { die: Die::D12, quantity: 2 }.to_die()),(DamageType::Existential, SerialDie { die: Die::D12, quantity: 2 }.to_die()),]),
			damage: HashMap::new(),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Artifact,
...
impl LegguardsOfInvincibleAegis {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			armor: SerialDie {die:Die::D12, quantity:4 }.to_die(),
			resistance: HashMap::from([(DamageType::Dark, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Light, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::NonElemental, SerialDie { die: Die::D20, quantity: 1 }.to_die()),(DamageType::Hope, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Holy, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Iron, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Physical, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Existential, SerialDie { die: Die::D8, quantity: 1 }.to_die()),]),
			damage: HashMap::new(),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Legendary,
...
impl BootsOfElementalMastery {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			armor: SerialDie {die:Die::D12, quantity:4 }.to_die(),
			resistance: HashMap::from([(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			damage: HashMap::from([(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Legendary,
			value: 300,
...
impl RingOfResilientFortitude {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			slot: EquipmentSlot::Ring,
			armor: SerialDie {die:Die::D4, quantity:0 }.to_die(),
			resistance: HashMap::from([(DamageType::NonElemental, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Iron, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Dark, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Water, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Physical, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Holy, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Existential, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Hope, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Light, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Air, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D4, quantity: 1 }.to_die()),]),
			damage: HashMap::new(),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Epic,
...
impl VeilOfEternalDreams {
	pub fn generate(&self) -> IndividualItem {
		IndividualItem {
			...
			resistance: HashMap::from([(DamageType::Arcane, SerialDie { die: Die::D10, quantity: 3 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D12, quantity: 3 }.to_die()),]),
...
#[derive(ErisValidEnum,ErisConstructedTemplate,ErisDisplayEmoji, Serialize, Deserialize, Hash, PartialEq, Clone, Copy, Debug, Eq)]
