...
impl AmuletOfArcaneAscendance {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
			...
			armor: SerialDie {die:Die::D4, quantity:0 }.to_die(),
			resistance: HashMap::from([(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			damage: HashMap::from([(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
...
impl HelmOfTheDwarfBetrayer {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
            ...
            damage: HashMap::new(),
            attribute_bonus: SerialAttributes {
                strength: 10,
                dexterity: 0,
                constitution: 10,
                intelligence: 0,
...
impl LegguardsOfInvincibleAegis {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
			...
			armor: SerialDie {die:Die::D12, quantity:4 }.to_die(),
			resistance: HashMap::from([(DamageType::Holy, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Light, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Dark, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Existential, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Iron, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::NonElemental, SerialDie { die: Die::D20, quantity: 1 }.to_die()),(DamageType::Hope, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D8, quantity: 1 }.to_die()),(DamageType::Physical, SerialDie { die: Die::D8, quantity: 1 }.to_die()),]),
			damage: HashMap::new(),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Legendary,
...
impl BootsOfElementalMastery {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
			...
			damage: HashMap::from([(DamageType::Air, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Water, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Earth, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Legendary,
			value: 300,
...
impl DragonScaleArmor {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
			...
			damage: HashMap::from([(DamageType::Physical, SerialDie { die: Die::D8, quantity: 2 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D8, quantity: 2 }.to_die()),]),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
...
impl RingOfResilientFortitude {
    pub fn generate(&self) -> IndividualItem {
        IndividualItem {
			...
			slot: EquipmentSlot::Ring,
			armor: SerialDie {die:Die::D4, quantity:0 }.to_die(),
			resistance: HashMap::from([(DamageType::Earth, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Holy, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Iron, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Air, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Physical, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Prismatic, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Water, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Dark, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Light, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Despair, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Fire, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Existential, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Arcane, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::NonElemental, SerialDie { die: Die::D4, quantity: 1 }.to_die()),(DamageType::Hope, SerialDie { die: Die::D4, quantity: 1 }.to_die()),]),
			damage: HashMap::new(),
			attribute_bonus: SerialAttributes::zero().into(),
			action: 0,
			rarity: Rarity::Epic,
...
#[derive(
    ErisConstructedTemplate, Serialize, Deserialize, Hash, PartialEq, Clone, Copy, Debug, Eq,
)]
